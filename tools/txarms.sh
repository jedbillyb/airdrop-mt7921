...
echo ""
echo "Reading it:"
echo "  A PASS, B FAIL          - the §23 regression reproduced, carry on."
echo "  A PASS, B FAIL, C PASS  - the driver needs the re-tune. PIN's channel"
echo "                            choice is fine; ship a keepalive, do not revert."
echo "  A PASS, B FAIL, C FAIL  - the phone is refusing our advertised all-one-"
echo "                            channel sequence. Advertise a conformant"
echo "                            sequence while still sitting on one channel."
echo "  D not matching B        - the phone drifted mid-run. EVERY row is void."
echo "  A FAIL                  - phone was never reachable. Every row is void."
